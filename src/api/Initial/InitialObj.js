...
export const initialMemberArray = [
    {
        ...
        explain: [
            `1940년 10월 9일 ~ 1980년 12월 8일)은 영국의 싱어송라이터이자 대중음악 사상 가장 성공한 밴드이자 가장 영향력 있는 록 밴드인 비틀즈의 창립 멤버다. 그는 동료 폴 매카트니와 함께 가장 위대한 파트너십 중 하나로 간주되는 작곡 파트너십을 맺었다.`,
            `리버풀에서 나고 자란 레논은 청소년기에 대유행한 스키플에 편승하여 그의 첫 밴드인 쿼리멘을 결성하였고 1960년에 이름을 비틀즈로 바꾸어 활동했다. 1970년 비틀즈 해체 뒤 레논은 《John Lennon/Plastic Ono Band》, 《Imagine》 등의 음반과 〈Give Peace a Chance〉, 〈Working Class Hero〉, 〈Imagine〉 등의 곡을 발표하면서 산발적인 솔로 활동을 벌였다.`,
            `1969년 오노 요코와 결혼한 후 미들 네임에 "오노"를 추가한 그는 1975년부터 아들 숀을 돌보기 위해 음악 활동을 중단했고, 1980년 《Double Fantasy》를 발표하면서 복귀했으나 같은 해 12월 마크 채프먼이 쏜 총에 맞아 향년 40세의 나이에 사망했다.`,
            `레논의 마지막 음반이 된 《Double Fantasy》는 1982년에 열린 제24회 그래미 어워드에서 올해의 음반을 수상했다. 레논은 자신의 반항적인 성향과 통렬한 재치를 음악, 글, 그림, 영화, 인터뷰를 통해 표현했다.`,
            `1971년 미국 맨해튼으로 이주한 뒤로 체류 전반에 걸쳐 논란이 되는 정치적 및 평화 운동을 전개했으며 그의 베트남 전쟁에 대한 비판은 리처드 닉슨 행정부가 그를 추방하기 위한 오랜 시도를 낳았고, 한편 그가 작곡한 곡들은 반전쟁 운동의 앤섬으로 채택되거나 더 큰 반문화를 구축하는데 일조한다.`,
        ],
        roles: ["보컬", "리듬 기타"]
    },
    {
